...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        Alert::error('Failed', 'Product Data Failed to be Added.');
        return back()->with([
    ...
    public function update(ProductRequest $request,Product $product)
    {
        ...
        if ($request->validated()) {
            ...
            Alert::success('Edited Successfully', 'Product Data Edited Successfully.');
            return redirect()->route('admin.products.index');
        }

        Alert::error('Edit Failed', 'Product Data Failed to Edit.');
        return back()->with([
    ...
    public function destroy(Product $product)
    {
        ...
        Alert::success('Removed Successfully', 'Product Data Removed Successfully.');
