...
class CategoryController extends Controller
{
    ...
    public function store(CategoryRequest $request)
    {
        ...
        Alert::success('Added Successfully', 'Category Product Added Successfully.');
    ...
    public function update(CategoryRequest $request,Category $category)
    {
        ...
        Alert::success('Edited Successfully', 'Category Product Edited Successfully.');
    ...
    public function destroy(Category $category)
    {
        ...
        Alert::success('Removed Successfully', 'Category Product Removed Successfully.');
