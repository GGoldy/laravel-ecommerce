...
class TagController extends Controller
{
    ...
    public function store(TagRequest $request)
    {
        ...
        Alert::success('Added Successfully', 'Product Tag Added Successfully.');
    ...
    public function update(TagRequest $request,Tag $tag)
    {
       ...
       Alert::success('Edited Successfully', 'Product Tag Edited Successfully.');
        return redirect()->route('admin.tags.index')->with([
    ...
    public function destroy(Tag $tag)
    {
        ...
        $tag->delete();
        Alert::success('Removed Successfully', 'Product Tag Removed Successfully.');
        return redirect()->route('admin.tags.index')->with([
